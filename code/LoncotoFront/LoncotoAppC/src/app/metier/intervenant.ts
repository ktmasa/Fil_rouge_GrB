...
export class Intervenant{
    public constructor(public id:number,public nom:string,public prenom:string,public telephone:number,public mail:string,public specialite:string,public cvId:number,public intervenant?: Array<Intervenant>){}
